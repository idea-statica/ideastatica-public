...
| [calc-design-resitance-1](https://github.com/idea-statica/ideastatica-public/tree/main/src/api-sdks/connection-api/clients/python/examples/calc-design-resitance-1) | Calculate a sample project set up for design-resistance analysis. |
