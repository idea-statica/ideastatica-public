...
{
	//CIH - myslim ze neni potreba
	///// <summary>
	///// Alignment of Member 1D
	///// </summary>
	//public enum Member1DAlign
	//{
	//	/// <summary>
	//	/// Default alignment. Center of gravity of css in Line (in Axis)
	//	/// </summary>
	//	AlignAxis,
	...
	public class Member1D : OpenElementId
	{
		...
		//bude se sestavovat se segmentů
		///// <summary>
		///// Gets, sets geometry of this Member1D
		///// </summary>
		...
		//CIH - myslim ze neni potreba
		///// <summary>
		///// Aligment of Element1D along the Member1D
		///// </summary>
		//public Member1DAlign Member1DAlign { get; set; }
		...
		//CIH - myslim ze neni potreba
		///// <summary>
		///// Displacement in local Y dirrection
		///// </summary>
		//public System.Double LocalEccentricityY { get; set; }

		//CIH - myslim ze neni potreba
		///// <summary>
		///// Displacement in local Z dirrection
		///// </summary>
		//public System.Double LocalEccentricityZ { get; set; }
