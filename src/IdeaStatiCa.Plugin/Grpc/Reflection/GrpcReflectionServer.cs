...
namespace IdeaStatiCa.Plugin.Grpc.Reflection
{
	...
	public class GrpcReflectionServer : GrpcServer
	{
		...
		public GrpcReflectionServer(object instance, IPluginLogger logger, IBlobStorageProvider blobStorageProvider = null, int maxDataLength = Constants.GRPC_MAX_MSG_SIZE, int chunkSize = Constants.GRPC_CHUNK_SIZE) :
