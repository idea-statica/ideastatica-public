...
//	/// </summary>
//	internal class CrossSectionFactory : IFactory<RamSectionWrapper, IIdeaCrossSection>
//	{
...
//		public IIdeaCrossSection Create(IObjectFactory objectFactory, IImportSession importSession, RamSectionWrapper css)
//		{
...
//					return new RamCrossSectionByName() { Name = css.SectionLabel, Material = objectFactory.GetMaterial(css.MaterialId) };
//			}

//			var cssParametric = new RamCrossSectionParametric()
//			{
//				//TODO Confirm how to set Id as the section does not have a number identifier
//				Id = $"css-{css.No}",
//				Name = css.SectionLabel,
//				Material = objectFactory.GetMaterial(css.MaterialId),
//				Rotation = 0,
