...
namespace IdeaStatiCa.RamToIdea.Factories
{
	internal class ObjectFactory : IObjectFactory, IDataCache
	{
		...
		private readonly IFactory<RamSectionWrapper, IIdeaCrossSection> _crossSectionFactory;
		private readonly IFactory<RamMaterialWrapper, IIdeaMaterial> _materialFactory;
		...
		public IIdeaMember1D GetMember(int memberNo)
		{
			...
			return _members.GetOrCreate(memberNo,
				() =>
				{
					...
					return new RamMember(this, _modelDataProvider, _resultsFactory, _elementFactory, memberNo);
				});
		}
		...
		public IIdeaNode GetNode(int nodeNo)
		{
			...
			return _nodes.GetOrCreate(nodeNo,
				() => new RamNode(_importSession, _modelDataProvider, nodeNo));
		}
		...
		public IIdeaLoadCase GetLoadCase(int loadCaseNo)
		{
			...
			return _loadcases.GetOrCreate(loadCaseNo,
				() => new RamLoadCase(this, _loadsProvider, loadCaseNo));
		}
