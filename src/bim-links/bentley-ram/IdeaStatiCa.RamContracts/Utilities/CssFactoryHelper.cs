...
{
	public static class CssFactoryHelper
	{
		public static double RadiusDefault = 0.1e-2;
		public static void FillCssISection(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssIRolled(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssPipe(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssChannel(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssTube(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="D">depth</param>
			/// <param name="B">width</param>
		...
		public static void FillCssCircle(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			double d = props.Depth.InchesToMeters();
		...
		public static void FillCssTsection(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="cssGeomB">Css width</param>
			/// <param name="cssGeomH">Height of cross-section</param>
		...
		public static void FillCssRectangle(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssLSection(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssISectionWithHaunch(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="cssGeomB">Css width</param>
			/// <param name="cssGeomH">Height of cross-section</param>
			/// <param name="cssGeomS">Web thickness</param>
		...
		public static void FillCssAngle(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="B">width</param>
			/// <param name="D">depth</param>
			/// <param name="t">thickness</param>
		...
		public static void FillCssColdFormedZee(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
		...
		public static void FillCssColdFormedChannelWithLips(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="Width">Css width</param>
			/// <param name="Height">Height of cross-section</param>
			/// <param name="Thickness">Thickness</param>
		...
		public static void FillCssColdFormedChannel(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="Width">Css width</param>
			/// <param name="Height">Height of cross-section</param>
			/// <param name="Thickness">Thickness</param>
		...
		public static void FillShapeDblL(SteelSectionProperties props, CrossSectionParameter crossSectionParameter)
		{
			/// <param name="h">The height of css.</param>
			/// <param name="b">The width of css.</param>
			/// <param name="th">The bottom flange thisckness.</param>
