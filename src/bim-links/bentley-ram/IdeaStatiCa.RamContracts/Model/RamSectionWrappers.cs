...
namespace IdeaStatiCa.RamToIdea
{
	public class RamSectionWrapper
	{
		...
		public RAMDATAACCESSLib.ESTEEL_SEC SteelSectionShape = RAMDATAACCESSLib.ESTEEL_SEC.EStlNone; //peShape, Section shape
		public RAMDATAACCESSLib.ESTEEL_ROLLED_FLAG RolledFlag = RAMDATAACCESSLib.ESTEEL_ROLLED_FLAG.EStlRolled; //peRolledFlag, True if this is a rolled section

		public string SectionLabel = ""; //pstrSize, Section label
