...
/// <param name="connectionId">The local id of the connection to export.</param>
        ...
        /// <param name="connectionId">The ID of the connection to export.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
...
/// <param name="connectionId">The ID of the connection to export.</param>
        ...
        /// <param name="projectId">The unique identifier of the opened project.</param>
        /// <param name="connectionId">The ID of the connection to export.</param>
        /// <param name="version">Optional version string for downgrading the IOM model. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>string</returns>
...
/// <param name="version">Optional version string for downgrading the IOM model. (optional)</param>
        ...
        ConnectionData ExportIomConnectionData(Guid projectId, int connectionId, int operationIndex = 0);
...
/// <param name="connectionId">The ID of the connection to export.</param>
        ...
        ApiResponse<ConnectionData> ExportIomConnectionDataWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0);
    ...
    public interface IExportApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ConnectionData> ExportIomConnectionDataAsync(Guid projectId, int connectionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ConnectionData>> ExportIomConnectionDataWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
...
/// <param name="connectionId">The local id of the connection to export.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> ExportDWGWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<Object>("/api/5/projects/{projectId}/connections/{connectionId}/export-dwg", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> ExportDWGWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/5/projects/{projectId}/connections/{connectionId}/export-dwg", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">The ID of the connection to export.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<string> ExportIFCWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ExportApi.ExportIFC";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<string>("/api/5/projects/{projectId}/connections/{connectionId}/export-ifc", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<string>> ExportIFCWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<string>("/api/5/projects/{projectId}/connections/{connectionId}/export-ifc", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="version">Optional version string for downgrading the IOM model. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<string> ExportIomWithHttpInfo(Guid projectId, int connectionId, string version = default(string), string requestedType = null, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ExportApi.ExportIom";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<string>("/api/5/projects/{projectId}/connections/{connectionId}/export-iom", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<string>> ExportIomWithHttpInfoAsync(Guid projectId, int connectionId, string version = default(string), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<string>("/api/5/projects/{projectId}/connections/{connectionId}/export-iom", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConnectionData</returns>
        public ConnectionData ExportIomConnectionData(Guid projectId, int connectionId, int operationIndex = 0)
        {
            IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConnectionData> localVarResponse = ExportIomConnectionDataWithHttpInfo(projectId, connectionId);
            return localVarResponse.Data;
        }
...
/// <param name="connectionId">The ID of the connection to export.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ConnectionData</returns>
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConnectionData> ExportIomConnectionDataWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            IdeaStatiCa.ConnectionApi.Client.RequestOptions localVarRequestOptions = new IdeaStatiCa.ConnectionApi.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "ExportApi.ExportIomConnectionData";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<ConnectionData>("/api/5/projects/{projectId}/connections/{connectionId}/export-iom-connection-data", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ExportIomConnectionData", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ConnectionData</returns>
        public async System.Threading.Tasks.Task<ConnectionData> ExportIomConnectionDataAsync(Guid projectId, int connectionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConnectionData> localVarResponse = await ExportIomConnectionDataWithHttpInfoAsync(projectId, connectionId, null, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ConnectionData)</returns>
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConnectionData>> ExportIomConnectionDataWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ConnectionData>("/api/5/projects/{projectId}/connections/{connectionId}/export-iom-connection-data", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
