...
namespace IdeaStatiCa.ConnectionApi.Api
{
    ...
    public interface IProjectApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void CloseProject(Guid projectId, int operationIndex = 0);
        ...
        ApiResponse<Object> CloseProjectWithHttpInfo(Guid projectId, string requestedType = null, int operationIndex = 0);
        /// <summary>
        ...
        ApiResponse<ConProject> CreateEmptyProjectWithHttpInfo(ConProjectData conProjectData = default(ConProjectData), string requestedType = null, int operationIndex = 0);
        /// <summary>
        ...
        /// </summary>
        /// <exception cref="IdeaStatiCa.ConnectionApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="containerXmlFile">IdeaRS.OpenModel.OpenModelContainer serialized to xml. (optional)</param>
...
/// <param name="conProjectData">New project data to apply. The CountryCode field may keep the project&#39;s              current design code or switch it to one of ECEN, American, Canada, Australia, RUS, CHN, India or              HKG; switching to any other value of the enum is refused with 422. None keeps the current code. (optional)</param>
    ...
    public interface IProjectApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task CloseProjectAsync(Guid projectId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CloseProjectWithHttpInfoAsync(Guid projectId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Creates a new empty IdeaCon project with no connections.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ConProject> CreateEmptyProjectAsync(ConProjectData conProjectData = default(ConProjectData), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ConProject>> CreateEmptyProjectWithHttpInfoAsync(ConProjectData conProjectData = default(ConProjectData), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Downloads the current IdeaCon project from the service, including all changes made by previous API calls.
        /// </summary>
        /// <remarks>
    ...
    public partial class ProjectApi : IProjectApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void CloseProject(Guid projectId, int operationIndex = 0)
        {
            CloseProjectWithHttpInfo(projectId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> CloseProjectWithHttpInfo(Guid projectId, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<Object>("/api/5/projects/{projectId}/close", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task CloseProjectAsync(Guid projectId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await CloseProjectWithHttpInfoAsync(projectId, null, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> CloseProjectWithHttpInfoAsync(Guid projectId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/5/projects/{projectId}/close", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> localVarResponse = CreateEmptyProjectWithHttpInfo(conProjectData);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ConProject</returns>
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> CreateEmptyProjectWithHttpInfo(ConProjectData conProjectData = default(ConProjectData), string requestedType = null, int operationIndex = 0)
        {
            IdeaStatiCa.ConnectionApi.Client.RequestOptions localVarRequestOptions = new IdeaStatiCa.ConnectionApi.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "ProjectApi.CreateEmptyProject";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<ConProject>("/api/5/projects", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CreateEmptyProject", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ConProject</returns>
        public async System.Threading.Tasks.Task<ConProject> CreateEmptyProjectAsync(ConProjectData conProjectData = default(ConProjectData), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> localVarResponse = await CreateEmptyProjectWithHttpInfoAsync(conProjectData, null, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ConProject)</returns>
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject>> CreateEmptyProjectWithHttpInfoAsync(ConProjectData conProjectData = default(ConProjectData), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConProject>("/api/5/projects", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> DownloadProjectWithHttpInfo(Guid projectId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/api/5/projects/{projectId}/download", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> DownloadProjectWithHttpInfoAsync(Guid projectId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/5/projects/{projectId}/download", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConProject>> GetActiveProjectsWithHttpInfo(string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<ConProject>>("/api/5/projects", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConProject>>> GetActiveProjectsWithHttpInfoAsync(string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ConProject>>("/api/5/projects", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> GetProjectDataWithHttpInfo(Guid projectId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ConProject>("/api/5/projects/{projectId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject>> GetProjectDataWithHttpInfoAsync(Guid projectId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ConProject>("/api/5/projects/{projectId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionsToCreate"> (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> ImportIOMWithHttpInfo(System.IO.Stream containerXmlFile = default(System.IO.Stream), List<int> connectionsToCreate = default(List<int>), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ConProject>("/api/5/projects/import-iom-file", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject>> ImportIOMWithHttpInfoAsync(System.IO.Stream containerXmlFile = default(System.IO.Stream), List<int> connectionsToCreate = default(List<int>), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConProject>("/api/5/projects/import-iom-file", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> OpenProjectWithHttpInfo(System.IO.Stream ideaConFile = default(System.IO.Stream), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ConProject>("/api/5/projects/open", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject>> OpenProjectWithHttpInfoAsync(System.IO.Stream ideaConFile = default(System.IO.Stream), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConProject>("/api/5/projects/open", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="containerXmlFile">IdeaRS.OpenModel.OpenModelContainer serialized to xml. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> UpdateFromIOMWithHttpInfo(Guid projectId, System.IO.Stream containerXmlFile = default(System.IO.Stream), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ConProject>("/api/5/projects/{projectId}/update-iom-file", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject>> UpdateFromIOMWithHttpInfoAsync(Guid projectId, System.IO.Stream containerXmlFile = default(System.IO.Stream), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConProject>("/api/5/projects/{projectId}/update-iom-file", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="conProjectData">New project data to apply. The CountryCode field may keep the project&#39;s              current design code or switch it to one of ECEN, American, Canada, Australia, RUS, CHN, India or              HKG; switching to any other value of the enum is refused with 422. None keeps the current code. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject> UpdateProjectDataWithHttpInfo(Guid projectId, ConProjectData conProjectData = default(ConProjectData), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<ConProject>("/api/5/projects/{projectId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConProject>> UpdateProjectDataWithHttpInfoAsync(Guid projectId, ConProjectData conProjectData = default(ConProjectData), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ConProject>("/api/5/projects/{projectId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
