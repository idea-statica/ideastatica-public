...
/// <param name="memberId">The ID of the member to delete.</param>
        ...
        /// <exception cref="IdeaStatiCa.ConnectionApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">The unique identifier of the opened project in the ConnectionRestApi service.</param>
        /// <param name="connectionId">The ID of the connection containing the member.</param>
        /// <param name="memberId">The ID of the requested member in the connection.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConMember</returns>
...
/// <param name="memberId">The ID of the requested member in the connection.</param>
        ...
        /// <exception cref="IdeaStatiCa.ConnectionApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">The unique identifier of the opened project in the ConnectionRestApi service.</param>
        /// <param name="connectionId">The ID of the connection from which to retrieve members.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
...
/// <param name="connectionId">The ID of the connection from which to retrieve members.</param>
        ...
        /// <param name="projectId">The unique identifier of the opened project in the ConnectionRestApi service.</param>
        /// <param name="connectionId">The ID of the connection containing the member.</param>
        /// <param name="memberId">The ID of the member to set as bearing.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConMember</returns>
...
/// <param name="memberId">The ID of the member to set as bearing.</param>
        ...
        /// <exception cref="IdeaStatiCa.ConnectionApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">The unique identifier of the opened project in the ConnectionRestApi service.</param>
        /// <param name="connectionId">The ID of the connection containing the member to update.</param>
        /// <param name="conMember">The new member data to apply. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConMember</returns>
...
/// <param name="conMember">The member data for the new member. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember> AddMemberWithHttpInfo(Guid projectId, int connectionId, ConMember conMember = default(ConMember), string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember>> AddMemberWithHttpInfoAsync(Guid projectId, int connectionId, ConMember conMember = default(ConMember), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="memberId">The ID of the member to delete.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<int> DeleteMemberWithHttpInfo(Guid projectId, int connectionId, int memberId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<int>("/api/5/projects/{projectId}/connections/{connectionId}/members/{memberId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<int>> DeleteMemberWithHttpInfoAsync(Guid projectId, int connectionId, int memberId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<int>("/api/5/projects/{projectId}/connections/{connectionId}/members/{memberId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="memberId">The ID of the requested member in the connection.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember> GetMemberWithHttpInfo(Guid projectId, int connectionId, int memberId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members/{memberId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember>> GetMemberWithHttpInfoAsync(Guid projectId, int connectionId, int memberId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members/{memberId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">The ID of the connection from which to retrieve members.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConMember>> GetMembersWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<ConMember>>("/api/5/projects/{projectId}/connections/{connectionId}/members", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConMember>>> GetMembersWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ConMember>>("/api/5/projects/{projectId}/connections/{connectionId}/members", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="memberId">The ID of the member to set as bearing.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember> SetBearingMemberWithHttpInfo(Guid projectId, int connectionId, int memberId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members/{memberId}/set-bearing-member", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember>> SetBearingMemberWithHttpInfoAsync(Guid projectId, int connectionId, int memberId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members/{memberId}/set-bearing-member", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="conMember">The new member data to apply. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember> UpdateMemberWithHttpInfo(Guid projectId, int connectionId, ConMember conMember = default(ConMember), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConMember>> UpdateMemberWithHttpInfoAsync(Guid projectId, int connectionId, ConMember conMember = default(ConMember), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ConMember>("/api/5/projects/{projectId}/connections/{connectionId}/members", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
