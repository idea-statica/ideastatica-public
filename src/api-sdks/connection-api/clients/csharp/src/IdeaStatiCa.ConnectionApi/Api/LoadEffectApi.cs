...
/// <param name="connectionId">The ID of the connection.</param>
        ...
        /// <param name="projectId">The unique identifier of the opened project.</param>
        /// <param name="connectionId">The ID of the connection.</param>
        /// <param name="loadEffectId">The ID of the load effect to delete.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>int</returns>
...
/// <param name="connectionId">The ID of the connection.</param>
        ...
        /// <param name="projectId">The unique identifier of the opened project.</param>
        /// <param name="connectionId">The ID of the connection.</param>
        /// <param name="conLoadSettings">The new load settings to apply. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConLoadSettings</returns>
...
/// <param name="conLoadSettings">The new load settings to apply. (optional)</param>
        ...
        /// <param name="projectId">The unique identifier of the opened project.</param>
        /// <param name="connectionId">The ID of the connection.</param>
        /// <param name="conLoadEffect">The load effect data to update. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConLoadEffect</returns>
...
/// <param name="conLoadEffect">The load effect data to add. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadEffect> AddLoadEffectWithHttpInfo(Guid projectId, int connectionId, ConLoadEffect conLoadEffect = default(ConLoadEffect), string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<ConLoadEffect>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadEffect>> AddLoadEffectWithHttpInfoAsync(Guid projectId, int connectionId, ConLoadEffect conLoadEffect = default(ConLoadEffect), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConLoadEffect>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">The ID of the connection.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConLoadEffect>> CalculateLoadExtremesWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<ConLoadEffect>>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/calculate-load-extremes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConLoadEffect>>> CalculateLoadExtremesWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ConLoadEffect>>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/calculate-load-extremes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="loadEffectId">The ID of the load effect to delete.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<int> DeleteLoadEffectWithHttpInfo(Guid projectId, int connectionId, int loadEffectId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<int>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/{loadEffectId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<int>> DeleteLoadEffectWithHttpInfoAsync(Guid projectId, int connectionId, int loadEffectId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<int>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/{loadEffectId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="isPercentage">Optional flag indicating whether to return percentage-based load effects. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadEffect> GetLoadEffectWithHttpInfo(Guid projectId, int connectionId, int loadEffectId, bool? isPercentage = default(bool?), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ConLoadEffect>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/{loadEffectId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadEffect>> GetLoadEffectWithHttpInfoAsync(Guid projectId, int connectionId, int loadEffectId, bool? isPercentage = default(bool?), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ConLoadEffect>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/{loadEffectId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="isPercentage">Optional flag indicating whether to return percentage-based load effects. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConLoadEffect>> GetLoadEffectsWithHttpInfo(Guid projectId, int connectionId, bool? isPercentage = default(bool?), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<ConLoadEffect>>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConLoadEffect>>> GetLoadEffectsWithHttpInfoAsync(Guid projectId, int connectionId, bool? isPercentage = default(bool?), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ConLoadEffect>>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">The ID of the connection.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadSettings> GetLoadSettingsWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ConLoadSettings>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/get-load-settings", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadSettings>> GetLoadSettingsWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ConLoadSettings>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/get-load-settings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="conLoadSettings">The new load settings to apply. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadSettings> SetLoadSettingsWithHttpInfo(Guid projectId, int connectionId, ConLoadSettings conLoadSettings = default(ConLoadSettings), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ConLoadSettings>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/set-load-settings", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadSettings>> SetLoadSettingsWithHttpInfoAsync(Guid projectId, int connectionId, ConLoadSettings conLoadSettings = default(ConLoadSettings), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConLoadSettings>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects/set-load-settings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="conLoadEffect">The load effect data to update. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadEffect> UpdateLoadEffectWithHttpInfo(Guid projectId, int connectionId, ConLoadEffect conLoadEffect = default(ConLoadEffect), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<ConLoadEffect>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConLoadEffect>> UpdateLoadEffectWithHttpInfoAsync(Guid projectId, int connectionId, ConLoadEffect conLoadEffect = default(ConLoadEffect), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ConLoadEffect>("/api/5/projects/{projectId}/connections/{connectionId}/load-effects", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
