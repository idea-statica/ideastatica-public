...
/// <param name="requestBody">List of connection IDs to calculate.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConResultSummary>> CalculateWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<List<ConResultSummary>>("/api/5/projects/{projectId}/connections/calculate", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConResultSummary>>> CalculateWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ConResultSummary>>("/api/5/projects/{projectId}/connections/calculate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="loadEffectIds">Optional subset of load-effect ids of this connection to solve. When set,              exactly these load effects are analysed - their Active flags are ignored and nothing is persisted;              results - including subsequent results, raw-results, result-mesh and report reads - reflect only              this subset until the next calculation. When omitted, all active load effects are solved; an empty              list is treated as omitted. Unknown ids are rejected with 422. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConResultSummary> CalculateConnectionWithHttpInfo(Guid projectId, int connectionId, List<int> loadEffectIds = default(List<int>), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ConResultSummary>("/api/5/projects/{projectId}/connections/{connectionId}/calculate", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ConResultSummary>> CalculateConnectionWithHttpInfoAsync(Guid projectId, int connectionId, List<int> loadEffectIds = default(List<int>), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ConResultSummary>("/api/5/projects/{projectId}/connections/{connectionId}/calculate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="loadEffectIds">Optional subset of load-effect ids of this connection to solve. When set,              exactly these load effects are analysed - their Active flags are ignored and nothing is persisted;              results - including subsequent results, raw-results, result-mesh and report reads - reflect only              this subset until the next calculation. When omitted, all active load effects are solved; an empty              list is treated as omitted. Unknown ids are rejected with 422. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<string> GetConnectionRawJsonResultsWithHttpInfo(Guid projectId, int connectionId, List<int> loadEffectIds = default(List<int>), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<string>("/api/5/projects/{projectId}/connections/{connectionId}/rawresults-text", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<string>> GetConnectionRawJsonResultsWithHttpInfoAsync(Guid projectId, int connectionId, List<int> loadEffectIds = default(List<int>), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<string>("/api/5/projects/{projectId}/connections/{connectionId}/rawresults-text", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="requestBody">List of connection IDs to calculate.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<string>> GetRawJsonResultsWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<string>>("/api/5/projects/{projectId}/connections/rawresults-text", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<string>>> GetRawJsonResultsWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<string>>("/api/5/projects/{projectId}/connections/rawresults-text", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="requestBody">List of connection IDs to calculate.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConnectionCheckRes>> GetResultsWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<ConnectionCheckRes>>("/api/5/projects/{projectId}/connections/results", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConnectionCheckRes>>> GetResultsWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ConnectionCheckRes>>("/api/5/projects/{projectId}/connections/results", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
