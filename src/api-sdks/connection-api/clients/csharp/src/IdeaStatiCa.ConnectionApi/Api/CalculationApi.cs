...
/// <param name="requestBody"></param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConResultSummary>> CalculateWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<List<ConResultSummary>>("/api/2/projects/{projectId}/connections/calculate", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConResultSummary>>> CalculateWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ConResultSummary>>("/api/2/projects/{projectId}/connections/calculate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="conCalculationParameter">Type of requested analysis and connection to calculate (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<string>> GetRawJsonResultsWithHttpInfo(Guid projectId, ConCalculationParameter conCalculationParameter = default(ConCalculationParameter), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<string>>("/api/2/projects/{projectId}/connections/rawresults-text", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<string>>> GetRawJsonResultsWithHttpInfoAsync(Guid projectId, ConCalculationParameter conCalculationParameter = default(ConCalculationParameter), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<string>>("/api/2/projects/{projectId}/connections/rawresults-text", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="requestBody">List of connections to calculate and a type of CBFEM analysis</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConnectionCheckRes>> GetResultsWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<List<ConnectionCheckRes>>("/api/2/projects/{projectId}/connections/results", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<ConnectionCheckRes>>> GetResultsWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<List<ConnectionCheckRes>>("/api/2/projects/{projectId}/connections/results", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
