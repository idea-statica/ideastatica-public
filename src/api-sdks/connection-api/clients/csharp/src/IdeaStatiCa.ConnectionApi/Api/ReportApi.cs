...
/// <param name="connectionId">The ID of the connection to report.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> GenerateHtmlZipWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<Object>("/api/4/projects/{projectId}/connections/{connectionId}/reports/htmlZip", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> GenerateHtmlZipWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/4/projects/{projectId}/connections/{connectionId}/reports/htmlZip", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">The ID of the connection to report.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> GeneratePdfWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/api/4/projects/{projectId}/connections/{connectionId}/reports/pdf", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> GeneratePdfWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/4/projects/{projectId}/connections/{connectionId}/reports/pdf", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="requestBody">List of connection IDs to include in the report.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> GeneratePdfForMutlipleWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/api/4/projects/{projectId}/reports/pdf", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> GeneratePdfForMutlipleWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/4/projects/{projectId}/reports/pdf", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">The ID of the connection to report.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> GenerateWordWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Object>("/api/4/projects/{projectId}/connections/{connectionId}/reports/word", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> GenerateWordWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Object>("/api/4/projects/{projectId}/connections/{connectionId}/reports/word", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="requestBody">List of connection IDs to include in the report.</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> GenerateWordForMultipleWithHttpInfo(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/api/4/projects/{projectId}/reports/word", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> GenerateWordForMultipleWithHttpInfoAsync(Guid projectId, List<int> requestBody, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/4/projects/{projectId}/reports/word", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
