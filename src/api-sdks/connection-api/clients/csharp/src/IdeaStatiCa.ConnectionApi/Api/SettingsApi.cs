...
/// <param name="search">Optional parameter to search for keywords in settings. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Dictionary<string, Object>> GetSettingsWithHttpInfo(Guid projectId, string search = default(string), string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<Dictionary<string, Object>>("/api/3/projects/{projectId}/settings", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Dictionary<string, Object>>> GetSettingsWithHttpInfoAsync(Guid projectId, string search = default(string), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Dictionary<string, Object>>("/api/3/projects/{projectId}/settings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="requestBody">Dictionary of key-value pairs representing settings to update. (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Dictionary<string, Object>> UpdateSettingsWithHttpInfo(Guid projectId, Dictionary<string, Object> requestBody = default(Dictionary<string, Object>), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Dictionary<string, Object>>("/api/3/projects/{projectId}/settings", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Dictionary<string, Object>>> UpdateSettingsWithHttpInfoAsync(Guid projectId, Dictionary<string, Object> requestBody = default(Dictionary<string, Object>), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Dictionary<string, Object>>("/api/3/projects/{projectId}/settings", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
