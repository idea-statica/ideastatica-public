...
/// <param name="connectionId">Id of the connection where to clear the parameters</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> ClearParametersWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<Object>("/api/1/projects/{projectId}/connections/{connectionId}/clear-parameters", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> ClearParametersWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/1/projects/{projectId}/connections/{connectionId}/clear-parameters", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
