...
/// <param name="ideaParameterUpdate">New values of parameters (optional)</param>
    ...
    public partial class ParameterApi : IParameterApi
    {
        ...
        /// <summary>
        /// Clear parameters and links for the connection connectionId in the project projectId &lt;strong&gt;DEPRECATED:&lt;/strong&gt; This endpoint is deprecated and will be removed in a future version.               Please use the DELETE endpoint instead: &#x60;DELETE /api/v1/projects/{projectId}/connections/{connectionId}/parameters&#x60;
        /// </summary>
        /// <exception cref="IdeaStatiCa.ConnectionApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="projectId">The unique identifier of the opened project in the ConnectionRestApi service</param>
        /// <param name="connectionId">Id of the connection where to clear the parameters</param>
...
/// <param name="connectionId">Id of the connection where to clear the parameters</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> ClearParametersWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<Object>("/api/3/projects/{projectId}/connections/{connectionId}/clear-parameters", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> ClearParametersWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/3/projects/{projectId}/connections/{connectionId}/clear-parameters", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="connectionId">Id of the connection where to delete parameters</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object> DeleteParametersWithHttpInfo(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/api/3/projects/{projectId}/connections/{connectionId}/parameters", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<Object>> DeleteParametersWithHttpInfoAsync(Guid projectId, int connectionId, string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/api/3/projects/{projectId}/connections/{connectionId}/parameters", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="body">Expression to evaluate (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<string> EvaluateExpressionWithHttpInfo(Guid projectId, int connectionId, string body = default(string), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<string>("/api/3/projects/{projectId}/connections/{connectionId}/evaluate-expression", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<string>> EvaluateExpressionWithHttpInfoAsync(Guid projectId, int connectionId, string body = default(string), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<string>("/api/3/projects/{projectId}/connections/{connectionId}/evaluate-expression", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="includeHidden">Include also hidden parameters (optional, default to false)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<IdeaParameter>> GetParametersWithHttpInfo(Guid projectId, int connectionId, bool? includeHidden = default(bool?), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<IdeaParameter>>("/api/3/projects/{projectId}/connections/{connectionId}/parameters", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<List<IdeaParameter>>> GetParametersWithHttpInfoAsync(Guid projectId, int connectionId, bool? includeHidden = default(bool?), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<IdeaParameter>>("/api/3/projects/{projectId}/connections/{connectionId}/parameters", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
...
/// <param name="ideaParameterUpdate">New values of parameters (optional)</param>
        ...
        public IdeaStatiCa.ConnectionApi.Client.ApiResponse<ParameterUpdateResponse> UpdateWithHttpInfo(Guid projectId, int connectionId, List<IdeaParameterUpdate> ideaParameterUpdate = default(List<IdeaParameterUpdate>), string requestedType = null, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<ParameterUpdateResponse>("/api/3/projects/{projectId}/connections/{connectionId}/parameters", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<IdeaStatiCa.ConnectionApi.Client.ApiResponse<ParameterUpdateResponse>> UpdateWithHttpInfoAsync(Guid projectId, int connectionId, List<IdeaParameterUpdate> ideaParameterUpdate = default(List<IdeaParameterUpdate>), string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ParameterUpdateResponse>("/api/3/projects/{projectId}/connections/{connectionId}/parameters", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
