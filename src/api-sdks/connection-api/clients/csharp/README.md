...
[**UpdateConnection**](docs/ConnectionApi.md#updateconnection) | Update data of a specific connection in the project
  ...
  Method | Description
  ------------- | -------------
[**GetDesignItemPicture**](docs/ConnectionLibraryApi.md#getdesignitempicture) | Retrieves a picture as a PNG image stream based on the specified picture identifier.
