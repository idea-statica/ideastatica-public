...
N_Sd   = -100e3     # brace axial force                 [N]
My_Sd  = 10e6    # brace in-plane bending moment     [N*mm]
Mz_Sd  = -5e6     # brace out-of-plane bending moment [N*mm]
...
N_chord   = 25e3   # chord axial force               [N]   (+tension)
My_chord  = -5e6    # chord in-plane bending moment     [N*mm]
Mz_chord  = 1.3e6   # chord out-of-plane bending moment [N*mm]
