    ...
    public class GetMemberExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Member.GetMember: " + e.Message);
    ...
    public class GetMembersExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Member.GetMembers: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class SetBearingMemberExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Member.SetBearingMember: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class UpdateMemberExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Member.UpdateMember: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
