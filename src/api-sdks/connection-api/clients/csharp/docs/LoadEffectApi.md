...
| [**CalculateLoadExtremesAsync**](LoadEffectApi.md#calculateloadextremesasync) | Calculates load extremes for the connection and keeps only the critical load effects active. |
| [**DeleteAllLoadEffectsAsync**](LoadEffectApi.md#deleteallloadeffectsasync) | Deletes every load effect in the specified connection, together with their internal forces. |
...
<a id="calculateloadextremes"></a>
## **CalculateLoadExtremesAsync**
> **List&lt;ConLoadEffect&gt; CalculateLoadExtremesAsync (Guid projectId, int connectionId)**
...
namespace Example
{
    public class CalculateLoadExtremesAsyncExample
    {
        public static async Task Main()
        {
            string ideaConFile = "testCon.ideaCon";
            ...
            using (var clientFactory = new ConnectionApiServiceRunner(ideaStatiCaPath))
            {
                using (var conClient = await clientFactory.CreateApiClient())
                {
                    ...
                    {
                        // Calculates load extremes for the connection and keeps only the critical load effects active.
                        List<ConLoadEffect> result = await conClient.LoadEffect.CalculateLoadExtremesAsync(projectId, connectionId);
                        Debug.WriteLine(result);
                    }
                    catch (ApiException  e)
                    {
                        Console.WriteLine("Exception when calling LoadEffect.CalculateLoadExtremesAsync: " + e.Message);
                        Console.WriteLine("Status Code: " + e.ErrorCode);
                        Console.WriteLine(e.StackTrace);
                    }
                    finally
...
[!code-csharp[](../examples/CodeSamples/Samples/CalculateLoadExtremes.cs)]
...
#### Using the CalculateLoadExtremesWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Calculates load extremes for the connection and keeps only the critical load effects active.
    ApiResponse<List<ConLoadEffect>> response = conClient.LoadEffect.CalculateLoadExtremesWithHttpInfo(projectId, connectionId);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling LoadEffectApi.CalculateLoadExtremesWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
<a id="deleteallloadeffects"></a>
## **DeleteAllLoadEffectsAsync**
> **List&lt;int&gt; DeleteAllLoadEffectsAsync (Guid projectId, int connectionId)**
...
namespace Example
{
    public class DeleteAllLoadEffectsAsyncExample
    {
        public static async Task Main()
        {
            string ideaConFile = "testCon.ideaCon";
            ...
            using (var clientFactory = new ConnectionApiServiceRunner(ideaStatiCaPath))
            {
                using (var conClient = await clientFactory.CreateApiClient())
                {
                    ...
                    {
                        // Deletes every load effect in the specified connection, together with their internal forces.
                        List<int> result = await conClient.LoadEffect.DeleteAllLoadEffectsAsync(projectId, connectionId);
                        Debug.WriteLine(result);
                    }
                    catch (ApiException  e)
                    {
                        Console.WriteLine("Exception when calling LoadEffect.DeleteAllLoadEffectsAsync: " + e.Message);
                        Console.WriteLine("Status Code: " + e.ErrorCode);
                        Console.WriteLine(e.StackTrace);
                    }
                    finally
...
[!code-csharp[](../examples/CodeSamples/Samples/DeleteAllLoadEffects.cs)]
...
#### Using the DeleteAllLoadEffectsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Deletes every load effect in the specified connection, together with their internal forces.
    ApiResponse<List<int>> response = conClient.LoadEffect.DeleteAllLoadEffectsWithHttpInfo(projectId, connectionId);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling LoadEffectApi.DeleteAllLoadEffectsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
