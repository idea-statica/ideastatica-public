    ...
    public class CalculateExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Calculation.Calculate: " + e.Message);
    ...
    public class GetRawJsonResultsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Calculation.GetRawJsonResults: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetResultsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Calculation.GetResults: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
