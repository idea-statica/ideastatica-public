    ...
    public class AddBoltAssemblyExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.AddBoltAssembly: " + e.Message);
    ...
    public class AddCrossSectionExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.AddCrossSection: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class AddMaterialBoltGradeExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.AddMaterialBoltGrade: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class AddMaterialConcreteExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.AddMaterialConcrete: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class AddMaterialSteelExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.AddMaterialSteel: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class AddMaterialWeldExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.AddMaterialWeld: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetAllMaterialsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetAllMaterials: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetBoltAssembliesExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetBoltAssemblies: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetBoltGradeMaterialsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetBoltGradeMaterials: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetConcreteMaterialsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetConcreteMaterials: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetCrossSectionsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetCrossSections: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetSteelMaterialsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetSteelMaterials: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetWeldingMaterialsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Material.GetWeldingMaterials: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
