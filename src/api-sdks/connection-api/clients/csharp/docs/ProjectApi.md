    ...
    public class CloseProjectExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.CloseProject: " + e.Message);
    ...
    public class DownloadProjectExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.DownloadProject: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetActiveProjectsExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.GetActiveProjects: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetProjectDataExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.GetProjectData: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class GetSetupExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.GetSetup: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class ImportIOMExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.ImportIOM: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class OpenProjectExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.OpenProject: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class UpdateFromIOMExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.UpdateFromIOM: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class UpdateProjectDataExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.UpdateProjectData: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
    ...
    public class UpdateSetupExample
    {
        public static void Main()
        {
			...
			using (var conClient = await clientFactory.CreateConnectionApiClient())
			{
                ...
                {
                    Debug.Print("Exception when calling Project.UpdateSetup: " + e.Message);
                    Debug.Print("Status Code: " + e.ErrorCode);
                    Debug.Print(e.StackTrace);
                }
                finally
