...
class ConMemberPosition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["definedBy", "origin", "axisX", "axisY", "axisZ", "betaDirection", "gamaPitch", "alphaRotation", "offsetEx", "offsetEy", "offsetEz", "align", "alignedPlate", "relatedPlate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "origin": Vector3D.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
