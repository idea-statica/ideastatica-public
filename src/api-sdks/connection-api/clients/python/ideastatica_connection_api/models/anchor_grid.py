...
class AnchorGrid(BaseModel):
    ...
    headed_stud_head_diameter: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Head diameter of headed stud anchor.  Used when IdeaRS.OpenModel.Connection.AnchorGrid.AnchorType is IdeaRS.OpenModel.Parameters.AnchorType.HeadedStud.", alias="headedStudHeadDiameter")
    reinforcement_mandrel_diameter: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Mandrel diameter of reinforcement anchor.  Used when IdeaRS.OpenModel.Connection.AnchorGrid.AnchorType is IdeaRS.OpenModel.Parameters.AnchorType.Reinforcement.", alias="reinforcementMandrelDiameter")
