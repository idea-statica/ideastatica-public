...
class ConnectionCheckRes(BaseModel):
    ...
    ConnectionCheckRes
    """ # noqa: E501
    check_res_summary: Optional[List[CheckResSummary]] = Field(default=None, alias="checkResSummary")
    check_res_plate: Optional[List[CheckResPlate]] = Field(default=None, alias="checkResPlate")
    check_res_weld: Optional[List[CheckResWeld]] = Field(default=None, alias="checkResWeld")
    check_res_bolt: Optional[List[CheckResBolt]] = Field(default=None, alias="checkResBolt")
    check_res_anchor: Optional[List[CheckResAnchor]] = Field(default=None, alias="checkResAnchor")
    check_res_concrete_block: Optional[List[CheckResConcreteBlock]] = Field(default=None, alias="checkResConcreteBlock")
    buckling_results: Optional[List[BucklingRes]] = Field(default=None, alias="bucklingResults")
