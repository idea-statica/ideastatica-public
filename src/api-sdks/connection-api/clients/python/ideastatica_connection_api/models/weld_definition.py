...
class WeldDefinition(BaseModel):
    """
    Weld definition for cut operations (web or flange weld).
    """ # noqa: E501
    thickness: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Thickness of the weld - value 0 = recommended size")
    ...
    __properties: ClassVar[List[str]] = ["thickness", "weldType", "weldMaterial"]
