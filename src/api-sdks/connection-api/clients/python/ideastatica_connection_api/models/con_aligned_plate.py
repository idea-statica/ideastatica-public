...
class ConAlignedPlate(BaseModel):
    ...
    part_type_sequence: Optional[StrictInt] = Field(default=None, alias="partTypeSequence")
    __properties: ClassVar[List[str]] = ["plateSide", "memberId", "partType", "partTypeSequence"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if part_type_sequence (nullable) is None
        # and model_fields_set contains the field
        if self.part_type_sequence is None and "part_type_sequence" in self.model_fields_set:
            _dict['partTypeSequence'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "partTypeSequence": obj.get("partTypeSequence")
        })
        return _obj
