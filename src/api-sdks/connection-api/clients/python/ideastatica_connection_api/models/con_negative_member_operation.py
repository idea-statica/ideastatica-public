...
class ConNegativeMemberOperation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["crossSectionId", "length1", "length2", "mirrorY", "mirrorZ", "positioning", "isImported", "operationType", "id", "name", "active"]
