...
class ConAddOperationResult(BaseModel):
    """
    ConAddOperationResult
    """ # noqa: E501
    operation: Optional[ConOperation] = None
    issues: Optional[List[ConNonConformityIssue]] = None
    added_without_issues: Optional[StrictBool] = Field(default=None, alias="addedWithoutIssues")
    __properties: ClassVar[List[str]] = ["operation", "issues", "addedWithoutIssues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operation": ConOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "issues": [ConNonConformityIssue.from_dict(_item) for _item in obj["issues"]] if obj.get("issues") is not None else None,
            "addedWithoutIssues": obj.get("addedWithoutIssues")
        })
        return _obj
