...
class ConCssLineSegment(ConCssSegment):
    """
    ConCssLineSegment
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["segmentType", "start", "end", "$type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "$type": obj.get("$type") if obj.get("$type") is not None else 'IdeaStatiCa.Api.Connection.Model.Material.ConCssLineSegment, IdeaStatiCa.Api'
        })
        return _obj
