...
class ConCrossSectionGeometry(BaseModel):
    """
    ConCrossSectionGeometry
    """ # noqa: E501
    components: Optional[List[ConCrossSectionGeometryComponent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "components": [ConCrossSectionGeometryComponent.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
        return _obj
