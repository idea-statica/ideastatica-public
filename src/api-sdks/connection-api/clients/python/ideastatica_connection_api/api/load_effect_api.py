...
class LoadEffectApi:
    ...
    def _add_load_effect_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/load-effects',
    ...
    def calculate_load_extremes(
        ...
        _param = self._calculate_load_extremes_serialize(
            project_id=project_id,
            connection_id=connection_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def calculate_load_extremes_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        _request_timeout: Union[
    ...
    @validate_call
    def calculate_load_extremes_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        _request_timeout: Union[
    ...
    def _calculate_load_extremes_serialize(
        self,
        project_id,
        connection_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/load-effects/calculate-load-extremes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_all_load_effects(
        ...
        _param = self._delete_all_load_effects_serialize(
            project_id=project_id,
            connection_id=connection_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_all_load_effects_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_all_load_effects_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        _request_timeout: Union[
    ...
    def _delete_all_load_effects_serialize(
        self,
        project_id,
        connection_id,
        _request_auth,
    ...
    def delete_load_effect(
        ...
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        load_effect_id: Annotated[StrictInt, Field(description="The ID of the load effect to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param connection_id: The ID of the connection. (required)
        :type connection_id: int
        :param load_effect_id: The ID of the load effect to delete. (required)
    ...
    def _delete_load_effect_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/load-effects/{loadEffectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_load_settings_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/load-effects/get-load-settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_load_settings(
        ...
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        con_load_settings: Annotated[Optional[ConLoadSettings], Field(description="The new load settings to apply.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param connection_id: The ID of the connection. (required)
        :type connection_id: int
        :param con_load_settings: The new load settings to apply.
    ...
    def _set_load_settings_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/load-effects/set-load-settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_load_effect(
        ...
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection.")],
        con_load_effect: Annotated[Optional[ConLoadEffect], Field(description="The load effect data to update.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param connection_id: The ID of the connection. (required)
        :type connection_id: int
        :param con_load_effect: The load effect data to update.
        :type con_load_effect: ConLoadEffect
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
