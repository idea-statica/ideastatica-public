...
class LoadEffectApi:
    ...
    def _add_load_effect_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/load-effects',
    ...
    def _delete_load_effect_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/load-effects/{loadEffectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_load_settings_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/load-effects/get-load-settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_load_settings_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/load-effects/set-load-settings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
