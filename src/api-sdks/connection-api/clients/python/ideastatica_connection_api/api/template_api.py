...
class TemplateApi:
    ...
    def _apply_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/apply-template',
    ...
    @validate_call
    def clear_design_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service")],
        connection_id: Annotated[StrictInt, Field(description="Id of the connection where to clear the design")],
        _request_timeout: Union[
    ...
    @validate_call
    def clear_design_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service")],
        connection_id: Annotated[StrictInt, Field(description="Id of the connection where to clear the design")],
        _request_timeout: Union[
    ...
    def _clear_design_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/clear-design',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _create_con_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/get-template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/templates/{templateId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/templates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _explode_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/templates/{templateId}/explode',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _explode_all_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/templates/explode',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_connection_topology(
        ...
        _param = self._get_connection_topology_serialize(
            project_id=project_id,
            connection_id=connection_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_connection_topology_serialize(
        self,
        project_id,
        connection_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/get-topology',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_default_template_mapping_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/get-default-mapping',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_template_common_operation_properties_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/templates/{templateId}/common-properties',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_templates_for_connection(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ConConnectionTemplateModel]:
        ...
        _param = self._get_templates_for_connection_serialize(
            project_id=project_id,
            connection_id=connection_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ConConnectionTemplateModel]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_templates_for_connection_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the project containing the connection.")],
        connection_id: Annotated[StrictInt, Field(description="The identifier of the connection for which templates are to be retrieved.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ConConnectionTemplateModel]]:
        """Retrieves a list of templates associated with a specific connection within a project.
    ...
    @validate_call
    def get_templates_for_connection_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the project containing the connection.")],
        connection_id: Annotated[StrictInt, Field(description="The identifier of the connection for which templates are to be retrieved.")],
        _request_timeout: Union[
    ...
    def _get_templates_for_connection_serialize(
        self,
        project_id,
        connection_id,
        _request_auth,
    ...
    def _load_defaults_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/templates/{templateId}/load-defaults',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _publish_connection_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/2/projects/{projectId}/connections/{connectionId}/publish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
