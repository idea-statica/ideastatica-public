...
class ExportApi:
    ...
    def _export_ifc_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/export-ifc',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _export_iom_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/export-iom',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _export_iom_connection_data_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/export-iom-connection-data',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
