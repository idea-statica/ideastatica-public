...
class ConnectionLibraryApi:
    ...
    def _get_design_item_picture_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/5/connection-library/get-picture',
    ...
    def _get_design_sets_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/5/connection-library/get-design-sets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/5/connection-library/get-template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _propose_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/propose',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _publish_connection_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/5/projects/{projectId}/connections/{connectionId}/publish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
