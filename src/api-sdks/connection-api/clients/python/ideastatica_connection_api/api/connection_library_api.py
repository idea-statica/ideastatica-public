...
class ConnectionLibraryApi:
    ...
    def _get_design_item_picture_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/connection-library/get-picture',
    ...
    def _get_design_sets_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/connection-library/get-design-sets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/connection-library/get-template',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _propose_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/propose',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def publish_connection(
        ...
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection whose template will be published.")],
        con_template_publish_param: Annotated[Optional[ConTemplatePublishParam], Field(description="Parameters describing the publish operation (name, author, design set type).")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type project_id: str
        :param connection_id: The ID of the connection whose template will be published. (required)
        :type connection_id: int
        :param con_template_publish_param: Parameters describing the publish operation (name, author, design set type).
    ...
    def _publish_connection_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/publish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
