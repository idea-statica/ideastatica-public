...
class ReportApi:
    ...
    def generate_html_zip(
        ...
        _param = self._generate_html_zip_serialize(
    ...
    @validate_call
    def generate_html_zip_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection to report.")],
        _request_timeout: Union[
    ...
    @validate_call
    def generate_html_zip_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection to report.")],
        _request_timeout: Union[
    ...
    def _generate_html_zip_serialize(
        self,
        project_id,
        connection_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/reports/htmlZip',
    ...
    def _generate_pdf_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/reports/pdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def generate_pdf_for_mutliple(
        ...
        _param = self._generate_pdf_for_mutliple_serialize(
            project_id=project_id,
    ...
    def _generate_pdf_for_mutliple_serialize(
        self,
        project_id,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/3/projects/{projectId}/reports/pdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _generate_word_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/reports/word',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def generate_word_for_multiple(
        ...
        _param = self._generate_word_for_multiple_serialize(
            project_id=project_id,
            request_body=request_body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _generate_word_for_multiple_serialize(
        self,
        project_id,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/3/projects/{projectId}/reports/word',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
