...
class CalculationApi:
    ...
    def get_result_mesh(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection whose result mesh is requested.")],
        result_type: Annotated[Optional[ResultOnMeshType], Field(description="Quantity returned per node: `Stress` = equivalent (von Mises) stress σ_Ed [Pa];  `Strain` = plastic strain ε_Pl [-]; `StrainCheck`; `FondationStress` = foundation  contact stress [Pa]; `OverallCheck`.")] = None,
        load_id: Annotated[Optional[StrictInt], Field(description="The id of the load case to read results for.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: The unique identifier of the opened project in the ConnectionRestApi service. (required)
        :type project_id: str
        :param connection_id: The ID of the connection whose result mesh is requested. (required)
        :type connection_id: int
        :param result_type: Quantity returned per node: `Stress` = equivalent (von Mises) stress σ_Ed [Pa];  `Strain` = plastic strain ε_Pl [-]; `StrainCheck`; `FondationStress` = foundation  contact stress [Pa]; `OverallCheck`.
        :type result_type: ResultOnMeshType
        :param load_id: The id of the load case to read results for.
        :type load_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_result_mesh_serialize(
            project_id=project_id,
    ...
    @validate_call
    def get_result_mesh_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection whose result mesh is requested.")],
        result_type: Annotated[Optional[ResultOnMeshType], Field(description="Quantity returned per node: `Stress` = equivalent (von Mises) stress σ_Ed [Pa];  `Strain` = plastic strain ε_Pl [-]; `StrainCheck`; `FondationStress` = foundation  contact stress [Pa]; `OverallCheck`.")] = None,
    ...
    @validate_call
    def get_result_mesh_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection whose result mesh is requested.")],
        result_type: Annotated[Optional[ResultOnMeshType], Field(description="Quantity returned per node: `Stress` = equivalent (von Mises) stress σ_Ed [Pa];  `Strain` = plastic strain ε_Pl [-]; `StrainCheck`; `FondationStress` = foundation  contact stress [Pa]; `OverallCheck`.")] = None,
    ...
    def _get_result_mesh_serialize(
        self,
        project_id,
        connection_id,
        result_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/result-mesh',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
