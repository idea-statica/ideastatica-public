...
class MemberApi:
    ...
    def add_member(
        ...
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection to add the member to.")],
        con_member: Annotated[Optional[ConMember], Field(description="The member data for the new member.")] = None,
        ...
        :type project_id: str
        :param connection_id: The ID of the connection to add the member to. (required)
        :type connection_id: int
        :param con_member: The member data for the new member.
    ...
    def _add_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/members',
    ...
    def delete_member(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection containing the member to delete.")],
        member_id: Annotated[StrictInt, Field(description="The ID of the member to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: The unique identifier of the opened project in the ConnectionRestApi service. (required)
        :type project_id: str
        :param connection_id: The ID of the connection containing the member to delete. (required)
        :type connection_id: int
        :param member_id: The ID of the member to delete. (required)
        :type member_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/members/{memberId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_bearing_member(
        ...
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the connection containing the member.")],
        member_id: Annotated[StrictInt, Field(description="The ID of the member to set as bearing.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param connection_id: The ID of the connection containing the member. (required)
        :type connection_id: int
        :param member_id: The ID of the member to set as bearing. (required)
        :type member_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _set_bearing_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/4/projects/{projectId}/connections/{connectionId}/members/{memberId}/set-bearing-member',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
