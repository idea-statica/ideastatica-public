...
class ConnectionApi:
    ...
    def copy_connection(
        ...
        connection_id: Annotated[StrictInt, Field(description="The ID of the source connection to copy.")],
        name: Annotated[Optional[StrictStr], Field(description="Optional name for the new connection. If null or empty, a unique name is derived from the source connection name.")] = None,
        ...
        :type project_id: str
        :param connection_id: The ID of the source connection to copy. (required)
        :type connection_id: int
        :param name: Optional name for the new connection. If null or empty, a unique name is derived from the source connection name.
        :type name: str
        ...
        _param = self._copy_connection_serialize(
    ...
    @validate_call
    def copy_connection_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the source connection to copy.")],
        name: Annotated[Optional[StrictStr], Field(description="Optional name for the new connection. If null or empty, a unique name is derived from the source connection name.")] = None,
    ...
    @validate_call
    def copy_connection_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        connection_id: Annotated[StrictInt, Field(description="The ID of the source connection to copy.")],
        name: Annotated[Optional[StrictStr], Field(description="Optional name for the new connection. If null or empty, a unique name is derived from the source connection name.")] = None,
    ...
    def _copy_connection_serialize(
        self,
        project_id,
        connection_id,
        name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/copy',
    ...
    @validate_call
    def create_empty_connection(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        name: Annotated[Optional[StrictStr], Field(description="Optional connection name. If null or empty, a default name `CON{newId}` is assigned.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: The unique identifier of the opened project in the ConnectionRestApi service. (required)
        :type project_id: str
        :param name: Optional connection name. If null or empty, a default name `CON{newId}` is assigned.
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._create_empty_connection_serialize(
            project_id=project_id,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def create_empty_connection_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        name: Annotated[Optional[StrictStr], Field(description="Optional connection name. If null or empty, a default name `CON{newId}` is assigned.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_empty_connection_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        name: Annotated[Optional[StrictStr], Field(description="Optional connection name. If null or empty, a default name `CON{newId}` is assigned.")] = None,
        _request_timeout: Union[
    ...
    def _create_empty_connection_serialize(
        self,
        project_id,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/3/projects/{projectId}/connections',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_connection_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_connection_topology_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/get-topology',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_production_cost_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/3/projects/{projectId}/connections/{connectionId}/production-cost',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
