...
class MaterialApi:
    ...
    def get_material_library(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the opened project in the ConnectionRestApi service.")],
        material_type: Annotated[StrictStr, Field(description="Material type to list (steel, concrete, bolt-grade, welding, headed-stud-grade, reinforcement).")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: The unique identifier of the opened project in the ConnectionRestApi service. (required)
        :type project_id: str
        :param material_type: Material type to list (steel, concrete, bolt-grade, welding, headed-stud-grade, reinforcement). (required)
