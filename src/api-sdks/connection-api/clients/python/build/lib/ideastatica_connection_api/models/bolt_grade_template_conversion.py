...
class BoltGradeTemplateConversion(BaseTemplateConversion):
    """
    BoltGradeTemplateConversion
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='IdeaStatiCa.Api.Connection.Model.BoltGradeTemplateConversion, IdeaStatiCa.Api', alias="$type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "$type": obj.get("$type") if obj.get("$type") is not None else 'IdeaStatiCa.Api.Connection.Model.BoltGradeTemplateConversion, IdeaStatiCa.Api'
        })
        return _obj
