...
with connection_api_service_attacher.ConnectionApiServiceAttacher(baseUrl).create_api_client() as api_client:
    try:
        ...
        # the analysis type is taken from the connection itself (connection1.analysis_type),
        # set it with api_client.connection.update_connection before calculating
        connection_ids = [connection1.id]

        # run CBFEM analysis for the connection
...
[**get_version**](docs/ClientApi.md#get_version) | Gets the IdeaStatica API assembly version.
  ...
  Method | Description
  ------------- | -------------
[**copy_connection**](docs/ConnectionApi.md#copy_connection) | Creates a copy of an existing connection in the project.
[**create_empty_connection**](docs/ConnectionApi.md#create_empty_connection) | Adds a new empty connection to the project.
...
[**delete_member**](docs/MemberApi.md#delete_member) | Deletes the specified member from the connection.
...
[**create_empty_project^**](docs/ProjectApi.md#create_empty_project) | Creates a new empty IdeaCon project with no connections.
...
[**update_project_data**](docs/ProjectApi.md#update_project_data) | Updates ConProjectData of project.
  ...
  Method | Description
  ------------- | -------------
[**generate_html_zip^**](docs/ReportApi.md#generate_html_zip) | Generates a report for the specified connection in PDF, Word, or HTML zip format.
[**generate_pdf^**](docs/ReportApi.md#generate_pdf) | Generates a report for the specified connection in PDF, Word, or HTML zip format.
...
[**generate_word^**](docs/ReportApi.md#generate_word) | Generates a report for the specified connection in PDF, Word, or HTML zip format.
