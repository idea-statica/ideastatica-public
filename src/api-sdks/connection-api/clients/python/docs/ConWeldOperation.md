...
con_weld_operation_instance = ConWeldOperation.from_json(json)
# print the JSON string representation of the object
print(con_weld_operation_instance.to_json())

# convert the object into a dict
con_weld_operation_dict = con_weld_operation_instance.to_dict()
# create an instance of ConWeldOperation from a dict
con_weld_operation_from_dict = ConWeldOperation.from_dict(con_weld_operation_dict)
```
