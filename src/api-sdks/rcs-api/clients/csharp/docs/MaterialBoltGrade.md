# IdeaStatiCa.RcsApi.Model.MaterialBoltGrade
Material bolt grade
...
------------ | ------------- | ------------- | -------------
**Fub** | **double** | Ultimate tensile strength | [optional] 
**Fyb** | **double** | Yield strength | [optional] 
**Elongation** | **double** | Elongation after fracture - for 20% elongation use value 0.2 | [optional] 
**Code** | **CountryCode** |  | [optional] 
**MprlElementID** | **Guid** | Name fo the bolt grade in MPRL database | [optional] 
**MprlTableID** | **Guid** | Unique ID of MPRL database table where the bolt grade was taken from. | [optional] 
