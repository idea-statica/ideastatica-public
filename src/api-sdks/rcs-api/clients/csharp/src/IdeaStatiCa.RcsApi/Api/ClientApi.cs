...
namespace IdeaStatiCa.RcsApi.Api
{
    ...
    public partial class ClientApi : IClientApi
    {
        ...
        /// <returns></returns>
        public ClientApi(IdeaStatiCa.RcsApi.Client.Configuration configuration)
        {
        ...
        public ClientApi(IdeaStatiCa.RcsApi.Client.ISynchronousClient client, IdeaStatiCa.RcsApi.Client.IAsynchronousClient asyncClient, IdeaStatiCa.RcsApi.Client.IReadableConfiguration configuration)
        {
        ...
        {
            IdeaStatiCa.RcsApi.Client.ApiResponse<string> localVarResponse = GetVersionWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public IdeaStatiCa.RcsApi.Client.ApiResponse<string> GetVersionWithHttpInfo(string requestedType = null, int operationIndex = 0)
        {
        ...
        {
            IdeaStatiCa.RcsApi.Client.ApiResponse<string> localVarResponse = await GetVersionWithHttpInfoAsync(null, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<IdeaStatiCa.RcsApi.Client.ApiResponse<string>> GetVersionWithHttpInfoAsync(string requestedType = null, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
