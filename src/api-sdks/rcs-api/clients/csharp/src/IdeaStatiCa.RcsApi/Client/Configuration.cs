...
namespace IdeaStatiCa.RcsApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "24.1.2.1474";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/24.1.2.1474/csharp");
        ...
        {
            string report = "C# SDK (IdeaStatiCa.RcsApi) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0\n";
            report += "    SDK Package Version: 24.1.2.1474\n";
