...
from ideastatica_rcs_api.api_response import ApiResponse, T as ApiResponseT
import ideastatica_rcs_api.models
from ideastatica_rcs_api import rest
from ideastatica_rcs_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/25.1.0.2640/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ideastatica_rcs_api.models, klass)
