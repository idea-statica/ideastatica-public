...
class SectionApi:
    ...
    def sections(
        ...
        _param = self._sections_serialize(
    ...
    @validate_call
    def sections_without_preload_content(
        self,
        project_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _sections_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/1/projects/{projectId}/sections',
    ...
    def _update_section_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if rcs_section is not None:
            _body_params = rcs_section
