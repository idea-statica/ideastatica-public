...
class CrossSectionApi:
    ...
    def import_reinforced_cross_section(
        ...
        _param = self._import_reinforced_cross_section_serialize(
            project_id=project_id,
            rcs_reinforced_cross_section_import_data=rcs_reinforced_cross_section_import_data,
    ...
    def _import_reinforced_cross_section_serialize(
        self,
        project_id,
        rcs_reinforced_cross_section_import_data,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if rcs_reinforced_cross_section_import_data is not None:
            _body_params = rcs_reinforced_cross_section_import_data
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/1/projects/{projectId}/cross-sections/import-reinforced-cross-section',
    ...
    def reinforced_cross_sections(
        ...
        _param = self._reinforced_cross_sections_serialize(
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RcsReinforcedCrossSection]",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def reinforced_cross_sections_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RcsReinforcedCrossSection]]:
        """Get reinforced cross sections
    ...
    def _reinforced_cross_sections_serialize(
        self,
        project_id,
        _request_auth,
        _content_type,
