...
class ConcreteCheckResults(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checkResults": [ConcreteCheckResult.from_dict(_item) for _item in obj["checkResults"]] if obj.get("checkResults") is not None else None,
            "overall": ConcreteCheckResultOverall.from_dict(obj["overall"]) if obj.get("overall") is not None else None
        })
        return _obj
