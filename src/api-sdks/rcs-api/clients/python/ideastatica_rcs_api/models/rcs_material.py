...
class RcsMaterial(BaseModel):
    """
    RcsMaterial
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    material_type: Optional[RcsMaterialType] = Field(default=None, alias="materialType")
    __properties: ClassVar[List[str]] = ["id", "name", "materialType"]
