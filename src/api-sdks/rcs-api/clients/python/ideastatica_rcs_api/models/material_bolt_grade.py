...
class MaterialBoltGrade(BaseModel):
    """
    Material bolt grade
    """ # noqa: E501
    fub: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ultimate tensile strength")
    fyb: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Yield strength")
    elongation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Elongation after fracture - for 20% elongation use value 0.2")
    code: Optional[CountryCode] = None
    mprl_element_id: Optional[StrictStr] = Field(default=None, description="Name fo the bolt grade in MPRL database", alias="mprlElementID")
    mprl_table_id: Optional[StrictStr] = Field(default=None, description="Unique ID of MPRL database table where the bolt grade was taken from.", alias="mprlTableID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fub": obj.get("fub"),
            "fyb": obj.get("fyb"),
            "elongation": obj.get("elongation"),
            "code": obj.get("code"),
            "mprlElementID": obj.get("mprlElementID"),
            "mprlTableID": obj.get("mprlTableID"),
            "name": obj.get("name"),
