...
class RcsCrossSectionData(BaseModel):
    """
    RcsCrossSectionData
    """ # noqa: E501
    name: Optional[StrictStr] = None
    cross_section_rotation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="crossSectionRotation")
    components: Optional[List[RcsCssComponentData]] = None
    __properties: ClassVar[List[str]] = ["name", "crossSectionRotation", "components"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": [RcsCssComponentData.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
        return _obj
