...
//{
//	[TestFixture]
//	public class BimObjectImporterTest.cs
//	{
...
//			return new BimImporter(model, project, logger, geometryProvider, new BimObjectImporter(logger, importer, resultImporter));
//		}
...
//			importer.Import(Arg.Any<IImportContext>(), Arg.Any<ImportedObjects.ConnectionPoint>()).Returns(iomConnectionPoint);
...
//			IImporter<IIdeaObject> importer = Substitute.For<IImporter<IIdeaObject>>();
//			importer.Import(Arg.Any<IImportContext>(), Arg.Any<ImportedObjects.ConnectionPoint>())
//				.Returns(_ => new IdeaRS.OpenModel.Connection.ConnectionPoint());
